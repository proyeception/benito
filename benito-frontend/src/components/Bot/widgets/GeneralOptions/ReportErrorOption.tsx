...
const ReportErrorOption = (props: ReportErrorOptionsProps | any) => {
  ...
  return <div style={{textAlign: "center"}}>
    <a href="mailto:proyeception@gmail.com" style={{color: "#2f3336"}}>
      <button style={{backgroundColor:"white", color: color, borderColor:color, cursor: "pointer", padding: "10px", borderRadius: "6px", margin: "auto"}}>O podes hacer click acá</button>
    </a>
  </div>;
};
