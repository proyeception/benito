...
const SearchBox = (props: Props) => (
  <div className='qui-search-box'>
    <div className='qui-search-filter'>
      ...
      <input className="qui-search-input" onChange={(e) => props.nameCallback(e.target.value)}></input>
    </div>
    <div className='qui-search-filter'>
      <div className='qui-font-text'>Categoria</div>
      <input className="qui-search-input" onChange={(e) => props.categoryCallback(e.target.value)}></input>
    </div>
    <div className='qui-search-filter'>
    ...
    <div className='qui-search-filter'>
      ...
      <input className="qui-search-input" onChange={(e) => props.keywordCallback(e.target.value)}></input>
    </div>
    <div className='qui-search-filter'>
      <div className='qui-font-text'>Documentación</div>
      <input className="qui-search-input" onChange={(e) => props.documentationCallback(e.target.value)}></input>
    </div>
    <button className='btn-primary qui-search-btn' onClick={() => props.searchCallback()}>Buscar</button>
  </div>
);
